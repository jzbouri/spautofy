...
def get_top_tracks() -> tuple[callable, dict]:
    ...
    tool_definition = {
        ...
        "description": "Get the top tracks listened to by a user. You can stipulate a time period. Sends the overall chart by default.",
        "parameters": {
            "type": "object",
            "properties": {
                "user": {
                    "type": "string",
                    "description": "The user name to fetch top tracks for."
                },
                "period": {
                    "type": "string",
                    "enum": ["overall", "7day", "1month", "3month", "6month", "12month"],
                    "description": "The time period over which to retrieve top tracks for."
                },
                "limit": {
                    "type": "integer",
