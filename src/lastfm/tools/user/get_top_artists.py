...
def get_top_artists() -> tuple[callable, dict]:
    ...
    tool_definition = {
        ...
        "description": "Get the top artists listened to by a user. You can stipulate a time period. Sends the overall chart by default.",
        "parameters": {
            "type": "object",
            "properties": {
                "user": {
                    "type": "string",
                    "description": "The user name to fetch top artists for."
                },
                "period": {
                    "type": "string",
                    "enum": ["overall", "7day", "1month", "3month", "6month", "12month"],
                    "description": "The time period over which to retrieve top artists for."
                },
                "limit": {
                    "type": "integer",
